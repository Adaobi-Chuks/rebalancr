...
const Home = () => {
    return (
        <section className="text-center flex flex-col items-center justify-center min-h-[80vh] px-4">
            <img src="/assets/Logomain.png" alt="Rebalancr Logo" className="h-48 mb-12" />
            ...
            <p className="text-lg max-w-3xl mx-auto mt-2 mb-6">
            ...
            <div className="mt-6 flex gap-6">
                ...
                <Link to="/features">
                    <button className="border border-[#E0E0E0] text-[#E0E0E0] px-8 py-4 font-semibold transition-all duration-200 transform hover:scale-110 hover:bg-[#0D0F1F] hover:text-[#00F5A0] cursor-pointer">
                        Know More
                    </button>
                </Link>
            </div>
