...
const Home = () => {
    return (
        <section className="text-center flex flex-col items-center justify-center min-h-[80vh] px-4">
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-4 sm:gap-6">
                <button className="bg-[#00F5A0] text-[#0D0F1F] px-6 py-3 sm:px-8 sm:py-4 font-semibold transition-all duration-200 transform hover:scale-110 hover:bg-[#00D495] cursor-pointer text-sm sm:text-base">
                    Get Started
                </button>
                <Link to="/features">
                    <button className="border border-[#E0E0E0] text-[#E0E0E0] px-6 py-3 sm:px-8 sm:py-4 font-semibold transition-all duration-200 transform hover:scale-110 hover:bg-[#0D0F1F] hover:text-[#00F5A0] cursor-pointer text-sm sm:text-base">
                        Know More
                    </button>
                </Link>
            </div>
